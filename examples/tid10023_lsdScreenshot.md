...
<template tid="2000017" version="0.0.8" commited="true">
  <attrs>
    <attr name="name" value="Demo - save webpage into an image file" />
    <attr name="desc" value="Demo - save webpage into an image file by screenshot" />
  ...
  <actions>
    ...
    <action_scroll_by maxtimes="0" interval="3000"></action_scroll_by>
    <action_setvar_get varname="content">
      <!-- Save the web page content to an png file named "title" -->
      <get_screenshot fullpage="true"></get_screenshot>
    </action_setvar_get>
  </actions>
</template>
```

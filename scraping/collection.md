# How to Collect Orignal Data

Original data can be collected through browser automation and API requests. For details, please refer to [Browser Automation vs API Requests](/scraping/browserVsApi).

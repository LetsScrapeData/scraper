...
* concurrency
* limit rating
* how to add a CapConfig: tid 9002
...
* HTTP headers: mainly used for APIs
* user data: other session data
* template example: tid 10053 or tid 10054

...
- **action_goto**：Navigates the page to the given _url_.
...
Note: action_setvar_get.get_cookie/get_localstorage retrieves relevant data from injected or newly collected state data, not from the page.

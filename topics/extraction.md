...
[The original data retrieved](/scraping/collection) includes HTML and API responses. The data formats include the following two types:
...
Refer to [How to Use Scripts](/topics/script) for details.
...
To enable data completion, set the _completed_ attribute of the **column_xxx** to true.
